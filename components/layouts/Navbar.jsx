  ...
  return (
    <nav className="navbar bg-base-100">
      <div className="flex-1">
        <Link href="/" className="btn btn-ghost text-xl">PSAJ</Link>
      </div>
      <div className="flex-none">
        <ul className="menu menu-horizontal px-1">
          <li><Link href="/matematika">Matematika</Link></li>
          <li><Link href="/indonesia">Indonesia</Link></li>
          <li>
            <button className="btn-circle btn" type="button" data-set-theme="dark" data-act-class="ACTIVECLASS">
          ...
          <li>
            <button className="btn-circle btn" type="button" data-set-theme="light" data-act-class="ACTIVECLASS">
          ...
          {/* <li>
            <details>
              ...
              <ul className="p-2 bg-base-100 rounded-t-none">
                <li><button type="button" data-set-theme="dark" data-act-class="ACTIVECLASS">Dark</button></li>
                <li><button type="button" data-set-theme="light" data-act-class="ACTIVECLASS">Light</button></li>
              </ul>
            </details>
          </li> */}
        </ul>
